...
import {adminSignUpUser} from "../services/Api"
...
const AdminSignUpPage = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      const response = await adminSignUpUser(adimnData);
      console.log("this is form sign Up Page",response)
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gray-900 font-sans text-gray-200 p-4">
      <div className="w-full max-w-md space-y-6 rounded-2xl bg-gray-800 p-8 shadow-2xl">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold tracking-tight text-white">Create an Account For Admin</h1>
        ...
        <p className="text-center text-sm text-gray-400">
          ...
          <a href="/admin/login" className="font-medium text-blue-400 hover:underline">
            Log in
          </a>
        </p>
      </div>
